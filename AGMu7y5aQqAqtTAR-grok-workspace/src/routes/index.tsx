...
const FOR_WHOM = [
  ...
  {
    title: "Хотите поддержать сердце и сосуды",
    body: "Смеси из свёклы, чеснока, зелени. Без лишней соли.",
  },
  {
    title: "Часто ноют колени и стопы",
...
const CHAPTERS = [
  ...
  },
  {
    ...
    blurb: "22 рецепта, когда после обеда тяжесть и вздутие.",
    count: "22 рецепта",
  },
  {
    roman: "IV",
    title: "Для кишечника",
    blurb: "10 рецептов: кефир, чернослив, лён, каши. Когда стул редкий.",
    count: "10 рецептов",
  },
  {
    roman: "V",
    title: "Когда после еды изжога",
    blurb: "10 мягких каш и киселей без лимона и томата.",
    count: "10 рецептов",
  },
  {
    roman: "VI",
    title: "Смеси для поддержки сосудов",
    blurb: "21 рецепт из свёклы, чеснока, зелени — без лишней соли.",
    count: "21 рецепт",
  },
  {
    roman: "VII",
    title: "Ванночки и компрессы",
    blurb: "17 расслабляющих ванночек и компрессов для стоп и коленей.",
    count: "17 рецептов",
  },
  {
    roman: "VIII",
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center lg:py-24">
        ...
        <div>
          ...
          <h2 className="mt-4 font-display text-4xl leading-[1.08] tracking-tight sm:text-5xl lg:text-6xl">
            Помощь из домашнего арсенала.
          </h2>
          <div className="mt-6 space-y-4 font-serif text-lg leading-relaxed text-ink-soft">
            <p>
              Рецепты смесей и напитков, которые помогают мне годами и которые
              точно прямо сейчас лежат у вас дома.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-12 grid gap-px overflow-hidden rounded-xl bg-cream/10 sm:grid-cols-2 lg:grid-cols-4">
            {FOR_WHOM.map((s, i) => (
              <article
                key={s.title}
                className="bg-forest-2 p-5 transition-transform duration-200 ease-[cubic-bezier(0.23,1,0.32,1)] hover:-translate-y-1 sm:p-6"
              >
