    ...
    <div className="min-h-svh bg-paper">
      ...
      <section className="relative isolate min-h-[88svh] overflow-hidden bg-forest text-cream">
        ...
        <div className="relative mx-auto flex min-h-[88svh] max-w-6xl flex-col justify-end px-4 pb-14 pt-24 sm:px-6 sm:pb-20">
          <p className="font-sans text-[0.72rem] tracking-[0.22em] text-cream/70 uppercase">
            Тимофей Багров
          </p>
          <h1 className="mt-3 max-w-2xl font-display text-[2.6rem] leading-[0.95] sm:text-6xl">
            130 домашних рецептов, которые работают
          </h1>
          <p className="mt-5 max-w-xl font-serif text-lg leading-relaxed text-cream/90 sm:text-xl">
      ...
      <section className="bg-forest py-16 text-cream sm:py-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-10 grid gap-px overflow-hidden rounded-xl bg-cream/10 sm:grid-cols-2 lg:grid-cols-4">
            {FOR_WHOM.map((s) => (
      ...
      <section id="toc" className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
        <h2 className="font-display text-4xl">Оглавление</h2>
        <ol className="mt-10 divide-y divide-line border-y border-line">
          {CHAPTERS.map((sec) => (
            ...
            >
              <span className="font-display text-2xl text-clay">{sec.roman}</span>
              <div>
                <p className="font-display text-2xl">{sec.title}</p>
                <p className="mt-1 max-w-2xl font-serif text-ink-soft">{sec.blurb}</p>
              </div>
              <span className="font-sans text-sm text-muted">{sec.count}</span>
            </li>
          ))}
        </ol>
      </section>
      ...
      <section id="sample" className="bg-paper-2/50 py-16 sm:py-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <h2 className="font-display text-4xl">Как будут выглядеть рецепты</h2>
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[minmax(0,1fr)_minmax(16rem,24rem)] lg:items-start lg:py-24">
        <div>
          ...
          <h2 className="mt-3 font-display text-4xl">Тимофей Багров</h2>
      ...
      <section id="buy" className="bg-forest py-16 text-cream sm:py-24">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_22rem] lg:items-center">
          <div>
            <p className="font-sans text-[0.72rem] tracking-[0.18em] text-cream/55 uppercase">
              Электронная книга
            </p>
          ...
          <div className="rounded-xl border border-cream/15 bg-forest-2 p-6">
            <p className="font-display text-5xl">{rub(book.price)}</p>
      ...
      <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24">
        <h2 className="font-display text-4xl">Частые вопросы</h2>
        <div className="mt-8 divide-y divide-line border-y border-line">
          {FAQ.map((f) => (
            <details key={f.q} className="group py-4">
              <summary className="cursor-pointer list-none font-sans text-base font-medium text-ink marker:content-none [&::-webkit-details-marker]:hidden">
